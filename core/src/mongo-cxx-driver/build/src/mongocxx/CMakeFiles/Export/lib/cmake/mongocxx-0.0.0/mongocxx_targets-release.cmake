...
set_target_properties(mongo::mongocxx_shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmongocxx.so.0.0.0"
  IMPORTED_SONAME_RELEASE "libmongocxx.so._noabi"
  )

list(APPEND _IMPORT_CHECK_TARGETS mongo::mongocxx_shared )
list(APPEND _IMPORT_CHECK_FILES_FOR_mongo::mongocxx_shared "${_IMPORT_PREFIX}/lib/libmongocxx.so.0.0.0" )
