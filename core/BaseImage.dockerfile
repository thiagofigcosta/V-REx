...
RUN apt-get install -y --no-install-recommends gcc-9 g++-9 build-essential cmake libboost-stacktrace-dev libssl-dev libsasl2-dev python-dev libboost-filesystem-dev 
